...
export function Congress2025() {
  const { t, getSpeakers2025, getDailyProgram2025, currentLanguage } = useLanguage();
  ...
  const speakers2025 = getSpeakers2025();
  const dailyProgram = getDailyProgram2025();
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex items-center justify-center gap-4 mb-4">
                <div className="text-6xl md:text-7xl lg:text-8xl font-light opacity-90">
                  2025
                </div>
              </div>
              <h1
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-8">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-lg">{t('congress.date-location-2025')}</span>
                </div>
                <div className="flex items-center gap-2">
                ...
                {speakers2025.map((speaker, index) => (
                  <Card key={index} className="overflow-hidden hover:shadow-lg transition-shadow duration-300">
                    ...
                    <CardContent className="p-6">
                      <h3 className="text-lg mb-2" style={{ fontFamily: "p22-mackinac-pro, serif" }}>
                        {speaker.name}
                      </h3>
                ...
                {dailyProgram.map((day, dayIndex) => (
                  <div key={dayIndex}>
                    ...
                    <div className={`grid grid-cols-1 gap-8 ${
                      ...
                      {day.conferences.map((conference, confIndex) => (
                        <Card key={confIndex} className="overflow-hidden flex flex-col">
